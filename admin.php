...
<div class="w3-row w3-border w3-white">
	...
	<div class="w3-right"><div class="w3-padding"><a href="login.php" class="w3-button w3-blue w3-round">Login</a></div></div>
	</div>
</div>
</div>
...
<div class="w3-content w3-containerx " style="max-width:600px">
	<div class="w3-margin w3-padding " >		
		...
		<div class="w3-xlarge w3-text-white w3-center"><b>ADMINISTRATOR</b></div>
		...
		<div class="w3-padding-32 w3-padding-large w3-round-xlarge w3-white">
			...
			<form action="" method="post" class="">		
				...
				<div class="w3-section" >
					<input class="w3-input w3-border w3-padding w3-round-large" type="text" name="username" placeholder="Username" required>
				</div>
